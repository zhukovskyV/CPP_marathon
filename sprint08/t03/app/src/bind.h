...
namespace Math {
    template<typename T>
    auto pow2 = std::bind(pow<T, int>, _1, 2);

    template<typename T>
    T add(const T arg1, const T arg2) {return arg1 + arg2;}
...
namespace Output {
    ...
    template<typename T>
    auto outputWeird3Arguments= std::bind(output3Arguments<T>, _2, _3, _1);
...
}  // end namespace SpecializedFunction
